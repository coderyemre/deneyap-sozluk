...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $error_message = "Kullanıcı adıveya şifre yanlış";
    }
...
<h3 class="card-title text-center"><a href="kaydol.html" style="text-decoration: none;">Eğer hesabınız yoksa hemen kaydolun</a></h3>
